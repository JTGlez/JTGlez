...
My hard skills can be resumed in the following: Python programming, Database Design, PL/SQL, Excel and basic web development. Also I'm studying Cryptography and Data Mining algorithms. On the other hand, I worked as a Project Manager of the GAINS V3.0 project of SIAFI UNAM using Scrum, where I trained the team in economic topics and collaborative tools to develop remotely their activities. Also, I have worked with different languages, libraries, and tools, as follows:
